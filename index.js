...
let personLarge = {...person, address:{ street: '123 Main St', city: 'New York', country: 'USA' }}
  //використовуємо деструктурізацію на об'єкті person
  let {name,age,address}=personLarge;
...
function copyObject(obj) {let obj1={...obj}; return obj1;
...
function hasProperty(obj, property) { if(property in obj){return `Property ${property} exists`;} 
...
function printKeysAndValues(obj) { for(const value in obj){ console.log(`Key: ${value}, Value: ${obj[value]}`);}
...
function deleteProperty(obj, property) { delete obj[property]; console.log(obj);
...
let user = {
  ...
  introduce: function(){return `My name is ${this.name} and I am ${this.age} yers old`;}
};
...
function addField(obj, newField, value) { obj[newField]=value; return obj;
...
function addProperty(array) {
  ...
  Array.prototype.costumPrototype="myProperty";
